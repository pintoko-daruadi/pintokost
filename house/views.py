...
class HouseCreateView(LoginRequiredMixin, PermissionRequiredMixin, SuccessMessageMixin, CreateView):
    ...
    template_name = 'house/rent_form.html'
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            messages.add_message(request, messages.ERROR,
                                 'Rumah dengan nama {}, sudah ada'.format(request.POST.get('name')))
            return render(request, template_name=self.template_name, context=self.get_context_data())


class HouseDeleteView(LoginRequiredMixin, PermissionRequiredMixin, SuccessMessageMixin, HouseOwnerMixin, DeleteView):
    model = House
