...
class Profile(models.Model):
    ...
    parent = models.ForeignKey(User, on_delete=models.PROTECT, verbose_name='Kepala Keluarga', null=True, blank=True,
                               related_name='children')
    nik = models.CharField('NIK KTP', max_length=16)
    occupation = models.CharField('Pekerjaan', max_length=100, null=True, blank=True)
    phone = models.CharField('Phone', max_length=100)
    bank_account = models.CharField('Bank', max_length=10, help_text='Bank yang digunakan', null=True, blank=True)
    bank_account_number = models.CharField('Nomor Rekening', max_length=50,
                                           help_text='Nomor rekening bank yang digunakan', null=True, blank=True)
    photo_ktp = models.FileField(blank=True, null=True, upload_to=profile_path)

    def get_photo_ktp(self):
        return self.photo_ktp.url if not self.photo_ktp else '/media/default.jpg'
